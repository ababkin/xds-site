<dfForm action="${action}" role="form" class="source" method="${method}">
  ...
  <div class="form-group" >
    <dfLabel ref="url.dataset_url" class="control-label required">And/Or Dataset URL</dfLabel>
    <dfInputText class="form-control" ref="url.dataset_url" placeholder="Enter dataset URL"/>
    <span class="help-block">
      <dfErrorList ref="url.dataset_url"/>
    </span>
  </div>
